...
<body>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link " href="{{ url('attendencep') }}">
                    <i class="bi bi-grid"></i>
                    <span>Todays Attendence</span>
                </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link " href="{{ url('expencess') }}">
                    <i class="bi bi-grid"></i>
                    <span>Expencess</span>
                </a>
            </li>
...
@yield('content')
    ...
    <script src="{{ asset('backendassets/vendor/echarts/echarts.min.jsv') }}"></script>
    <script src="{{ asset('backendassets/vendor/quill/quill.min.jsv') }}"></script>
